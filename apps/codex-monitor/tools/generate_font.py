...
def main():
    ...
    parser.add_argument("--output", type=Path, default=APP_ROOT / "target" / "include" / "font_data.h")
    parser.add_argument("--bold", type=Path, default=REPO_ROOT / "third_party" / "fonts" / "oxanium" / "Oxanium-Bold.ttf")
    parser.add_argument("--semibold", type=Path, default=REPO_ROOT / "third_party" / "fonts" / "oxanium" / "Oxanium-SemiBold.ttf")
