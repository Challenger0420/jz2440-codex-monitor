#!/usr/bin/env python3
"""Build the host-only large-number glyph inspection image."""
import os
import shutil
import subprocess
...
OUT = ROOT / "build" / "font-refinement" / "glyph-debug.ppm"
EXE = ROOT / "build" / "font-refinement" / "font-debug-renderer.exe"
...
def main():
    ...
    command = [cc, "-std=c99", "-O2", "-I", str(ROOT / "tools" / "preview_host_include"),
               ...
               str(ROOT / "apps" / "codex-monitor" / "tools" / "font_debug_main.c"), "-o", str(EXE)]
